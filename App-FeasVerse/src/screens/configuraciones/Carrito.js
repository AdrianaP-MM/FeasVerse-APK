...
const Carrito = ({ navigation }) => {
    ...
    const fetchCartData = async () => {
        try {
            ...
            const response = await fetch(`${Config.IP}/FeasVerse-Api/api/services/publica/carrito.php?action=readAll`);
            const text = await response.text();
            try {
    ...
    const handleDelete = async (id) => {
        try {
            ...
            const response = await fetch(`${Config.IP}/FeasVerse-Api/api/services/publica/carrito.php?action=deleteRow`, {
                method: 'POST',
                body: formData
            });
    ...
    const handleUpdateQuantity = async (id, id_detalle_zapato, quantity) => {
        ...
        try {
            ...
            console.log(id);
            const response = await fetch(`${Config.IP}/FeasVerse-Api/api/${ZAPATOS_API}?action=validationCantidad`, {
                method: 'POST',
                body: formData
            });
            ...
            const updateResponse = await fetch(`${Config.IP}/FeasVerse-Api/api/services/publica/carrito.php?action=updateRow`, {
                method: 'POST',
                body: updateFormData
            });
